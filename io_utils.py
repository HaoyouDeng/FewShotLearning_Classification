...
def parse_args(script):
    ...
    parser.add_argument('--testset', default='cub', help='miniImagenet/cub/cars/places/plantae/CropDiseases/EuroSAT/ISIC/chestX')
    ...
    parser.add_argument('--name', default='debug', type=str, help='ProtoNet/GNN/FEAT/FRN')
    ...
    parser.add_argument('--fix_layers', type=int, default=None, help='fix layers num in inner-loop')
    parser.add_argument('--ver', default=1, type=int, help='method version')
    ...
    if script == 'train':
        ...
        parser.add_argument('--not_warmup'  , action='store_true', help='continue from baseline, neglected if resume is true')
        parser.add_argument('--warmup_file' , default=None, help='warmup checkpoint file')
    elif script == 'save_features':
        parser.add_argument('--split'       , default='novel', help='base/val/novel') #default novel, but you can also test base/val class accuracy if you want 
        parser.add_argument('--save_iter', default=-1, type=int,help ='save feature from the model trained in x epoch, use the best model if x is -1')
    elif script == 'test':
        parser.add_argument('--test_file' , default=None, help='test model checkpoint file')
        parser.add_argument('--split'       , default='novel', help='base/val/novel') #default novel, but you can also test base/val class accuracy if you want 
