...
class MAML(MetaTemplate):
    ...
    def train_loop(self, epoch, train_loader, optimizer, total_it): #overwrite parrent function
        # print_freq = 10
        avg_loss=0
        task_count = 0
        loss_all = []
    ...
    def test_loop(self, test_loader, return_std = True): #overwrite parrent function
        correct =0
        count = 0
        acc_all = []
